...
button.onclick(function () {
    var input = inputArea.nodeValue();
    var type = parser.detecTypeInput(input);
    if (type.type == 'morse') {
        outputArea.nodeValue = parser.morseToText(input);
    } else {
        outputArea.nodeValue = parser.textToMorse(input);
    }
});
